...
def generate_launch_description():
    ...
    world = os.path.join(get_package_share_directory('autobot'), 'worlds', world_file_name)
    robot_desc_path = os.path.join(get_package_share_directory("autobot"),"description", "robot.urdf.xacro")
    gazebo_params_file = os.path.join(get_package_share_directory('autobot'), 'config', 'gazebo_params.yaml')
    ...
    start_gazebo_ros_spawner_cmd_0 = Node(
    package='gazebo_ros',
