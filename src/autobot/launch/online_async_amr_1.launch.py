...
def generate_launch_description():
    ...
    default_params_file = os.path.join(get_package_share_directory("autobot"),
                                       'config', 'mapper_params_amr_1.yaml')
    ...
    start_async_slam_toolbox_node = Node(
        ...
        name='slam_toolbox_amr_1',
        remappings=[
            ('/scan', '/amr_1/scan'),
            ('/map', '/map'),
            ('/slam_toolbox/feedback', '/amr_1/slam_toolbox/feedback'),
            ('/slam_toolbox/update', '/amr_1/slam_toolbox/update'),
            ('/slam_toolbox/scan_visualization', '/amr_1/slam_toolbox/scan_visualization'),
            ('/slam_toolbox/graph_visualization', '/amr_1/slam_toolbox/graph_visualization'),
        ],
